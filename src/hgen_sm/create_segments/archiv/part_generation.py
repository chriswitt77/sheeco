from config.design_rules import min_dist_mount_bend, min_flange_width, min_flange_length
import numpy as np
import pyvista as pv
from types import SimpleNamespace
from .utilities import normalize, closest_points_between_lines, perp_toward_plane
